package org.nearbyshops.preparedcartorderdao;
	...
	public ArrayList<CartItem> getCartItem(Integer endUserID, Integer shopID)
	{
		...
		try {
			...
			while(rs.next())
			{
				...
				cartItem.setItemID(rs.getInt(CartItem.ITEM_ID));
				cartItem.setItemQuantity(rs.getInt(CartItem.ITEM_QUANTITY));
				cartItem.setRtAvailableItemQuantity(rs.getInt("available_item_quantity"));
				cartItem.setRtItemPrice(rs.getDouble("item_price"));
...
//		+ " item_quantity, "
		...
		try {
			...
			while(rs.next())
			{
				...
				cartItem.setRtAvailableItemQuantity(rs.getInt(ShopItem.AVAILABLE_ITEM_QUANTITY));
				cartItem.setRtItemPrice(rs.getDouble(ShopItem.ITEM_PRICE));
